...
import com.slimgears.slimorm.interfaces.predicates.CompositePredicate;
import com.slimgears.slimorm.interfaces.predicates.FieldPredicate;
import com.slimgears.slimorm.interfaces.predicates.Predicate;
import com.slimgears.slimorm.interfaces.predicates.PredicateType;
...
import com.slimgears.slimorm.internal.PredicateVisitor;
...
public class SqlPredicateBuilder implements SqlStatementBuilder.PredicateBuilder {
    ...
    class BuilderVisitor<T> extends PredicateVisitor<T, String>  {
        ...
        private String[] substituteArgs(PredicateType type, Object... args) {
